  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-indigo-50 via-white to-slate-50">
      ...
      <div className="hidden md:flex md:w-1/2 bg-indigo-600 flex-col items-center justify-center p-12 text-white">
        ...
        <p className="text-indigo-200 text-center mb-8">Your complete learning management platform</p>
        <ul className="space-y-3 text-sm text-indigo-100">
          {["Access all your courses in one place", "Track grades and progress", "Submit work from anywhere"].map((t) => (
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-lg ring-1 ring-gray-100 p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" variant="primary" loading={loading} loadingText="Signing in…" className="w-full justify-center mt-2">
                Sign in
              </Button>
            </form>
            ...
            <p className="text-sm text-gray-500 mt-6 text-center">
              ...
              <Link href="/register" className="text-indigo-600 font-medium hover:text-indigo-700 underline underline-offset-2">Register</Link>
            </p>
          </div>
        </div>
      </div>
